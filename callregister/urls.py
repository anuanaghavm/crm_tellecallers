...
from .views import (
    ...
    FollowUpCallsView,
    WalkInListView,
    CallOutcomeFilterView,TelecallerCallSummaryView,TelecallerJobsView,NotAnsweredCallsView
)
...
urlpatterns = [
    ...
    path('jobs-view/',TelecallerJobsView.as_view(),name="telecallers-jobs")
]